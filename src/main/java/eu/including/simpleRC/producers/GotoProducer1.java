...
public class GotoProducer1 {

	final static GotoProducer1 rtlProd = new GotoProducer1();
	final static Integer partition = 13; 
	public static void main(String[] args) throws InterruptedException, ExecutionException, FileNotFoundException {
		...
		Double lat = 37.96424565879721;//Math.toRadians(41.80940313621358);0.6631501685058574,"longitude":0.4115732581134363
		Double lon =  23.611043835001116;//Math.toRadians(2.1643223535599345);
		...
		String command6 ="Establish_incident_perimeter";
		
		Double lat7 = 37.9641875201028;//Math.toRadians(41.80940313621358);0.6631501685058574,"longitude":0.4115732581134363
		Double lon7 =  23.611053524783518;//Math.toRadians(2.1643223535599345);
		...
		ManualTask task1 = new ManualTask(new Header("Resource Controller","Planner",(long) 1551344229L),111,lat,lon,command);
		...
		ManualTask task6 = new ManualTask(new Header("Resource Controller","Planner",(long) 1551344229L),161,lat5,lon5,command5);
		ManualTask task7 = new ManualTask(new Header("Resource Controller","Planner",(long) 1551344229L),171,lat5,lon5,command5);
