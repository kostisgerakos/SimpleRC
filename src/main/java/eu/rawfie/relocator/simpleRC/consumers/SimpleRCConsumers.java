...
public class SimpleRCConsumers {
  ...
  public SimpleRCConsumers(final String brokers,String schemaRegistry, String groupId,String testbed, final ArrayList<Pair<Integer,ArrayList<Triplet<Double,Double,Float>>>> coordinatesPerPartition, final Triplet<Boolean,Boolean,Double> functions,final GotoProducer gotoProducer ,final EventBus eventBus) {
